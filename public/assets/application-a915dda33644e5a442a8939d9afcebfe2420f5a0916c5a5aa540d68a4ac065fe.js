...
(function() {
  ...
  window.attachment_input = function(obj) {
    $(obj).parent().children('.file_field_class').click();
  };

  $(document).on('change', '#pictureInput', function() {
    var filename, files, image, image_link, pieces, reader, regex, str, val;
    str = $(this).val();
    pieces = str.split('\\');
